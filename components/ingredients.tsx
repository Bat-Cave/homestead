...
export const Ingredients = ({
	...
	const [refProduct, { width: widthProduct }] = useMeasure();
										...
										<div className="flex items-center w-full flex-wrap gap-2 mt-4 justify-center overflow-hidden">
											...
											>
												...
												>
													<span
														ref={ref}
														className="flex flex-col w-max items-center shrink-0"
													>
														<span className="text-xs uppercase w-full">
															Multiplier
														</span>
														<TextMorph
											...
											<m.span
												animate={{ width: widthProduct ?? "auto" }}
												className="shrink-0 flex"
											>
												<span ref={refProduct} className="shrink-0 flex">
													<TextMorph
														characterClassName={cn(
												...
												<DialogContent>
													...
													<ul className="list-disc list-inside space-y-1">
														{referencedRecipe.ingredients.map((ingredient) => {
															const scaledQuantity =
																ingredient.quantity *
																(internalServings / servings);
															const referencedUnit = unitMap.get(
																ingredient.unit,
															);
															const displayUnit =
																ingredient.unit === ""
													...
													<div className="space-y-2">
														...
														<ol className="list-decimal list-inside space-y-1">
															{referencedRecipe.steps.map((step) => (
																<li
																	key={`${referencedRecipe.slug}-step-${step}`}
																>
																	{step}
																</li>
															))}
											...
											<Popover>
												...
												<PopoverContent className="bg-none bg-transparent backdrop-blur-3xl p-2 btn-outline">
													<PopoverHeader>
														...
														<PopoverDescription className="sr-only">
															This is a list of alternatives for this
															ingredient.
														</PopoverDescription>
													</PopoverHeader>
